...
class ProfileRepository(val context: Context): ApiCallListener
{
    ...
    fun availabilityStatus(status: Int) {
        ...
        val statusCall = MyApp.MySingleton.getApiInterface()
            .setAvailabilityStatus(deliveryBoy.latitude, deliveryBoy.longitude, status)
